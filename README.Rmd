...
*plotting the various exon deltas across MCCs and MRGs
*annotating the ERs with junction data
*refining annotated ERs using the junction data
...
# To check the types of tissue you can filter for print(tissue_options)

annot_ers <- add_expressed_genes(tissue = "lung", gtf_path = gtf_path, annot_ers = annot_ers)
```

```{r refineER_example, echo = FALSE}
...
```{r get_count_matrix_example, echo = FALSE}
